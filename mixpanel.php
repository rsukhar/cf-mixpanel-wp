<?php
/*
Plugin Name: MixPanel for WordPress (Convertful)
Plugin URI: PLUGIN URL MUST be HERE
...
class mixPanel {
	...
	public function mixpanel_init() {
		...
		add_settings_section(
			'mixpanel_settings_section', 'Mixpanel', array( $this, 'print_section_info' ), 'mixpanel_options'
		);

		add_settings_field(
			'token_id', 'Mixpanel Token ID', // human readable part
			array( $this, 'my_text_input' ),  // the function that renders the field
			'mixpanel_options', 'mixpanel_settings_section', array(
...
include __DIR__ . '/ref_source.php';